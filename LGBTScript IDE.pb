...
Procedure SetupScintilla(Gadget)
  ...
  SetStyle(Gadget, #STYLE_KEYWORD_GENDER,     RGB(255, 255, 255), #VS_EDITOR_BG, #True)           ; gender - белый (основной цвет текста)
...
Procedure DrawToolbar()
  ...
  DrawRainbowH(0, 0, w, h - #STRIPE_H, 0.08, #VS_ACTIVITY_BG)
  DrawRainbowH(0, h - #STRIPE_H, w, #STRIPE_H, 0.9)
...
Procedure LayoutUI()
  ...
  ResizeGadget(#GAD_TOOLBAR, 0, 0, w, #TOOLBAR_H)
...
If OpenWindow(0, 0, 0, 1200, 780, "LGBTScript IDE v9.0",
              ...
              #PB_Window_MaximizeGadget | #PB_Window_MinimizeGadget | #PB_Window_SizeGadget | #PB_Window_Maximize )
